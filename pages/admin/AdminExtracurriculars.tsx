    ...
    return (
        <div>
            <div className="flex justify-between items-center mb-8">
                ...
                <button onClick={() => openForm('extracurricular', null)} className="bg-emerald-green text-white px-4 py-2 rounded-md hover:bg-emerald-600">
                    + Create New
                </button>
            </div>
                            ...
                            {items.map(item => (
                                <tr key={item.id} className="border-b dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700">
                                    ...
                                    <td className="p-4 flex gap-2">
                                        <button onClick={() => openForm('extracurricular', item)} className="text-blue-500 hover:underline text-sm">Edit</button>
