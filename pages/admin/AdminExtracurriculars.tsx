...
import { getExtracurriculars, addExtracurricular, updateExtracurricular, deleteExtracurricular, uploadImage } from '../../services/supabase'; // Diperbarui untuk menggunakan Supabase
