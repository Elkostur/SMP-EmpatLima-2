...
const ProgramCard: React.FC<{ title: string; description: string; icon: string }> = ({ title, description, icon }) => (
    <div className="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-md text-center hover:shadow-xl transition-shadow duration-300">
...
const FeaturedPrograms: React.FC = () => {
    return (
        <section id="programs" className="py-16 bg-gray-100 dark:bg-gray-900">
