        ...
        >
            <div className="container mx-auto px-6">
                ...
                {loading ? (
                    ...
                    <div 
                        ref={sectionRef}
                        className={`grid md:grid-cols-3 gap-8 mb-12 transform transition-all duration-700 ease-out ${hasEnteredViewport ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-[20px]'}`}
                    >
                        {staff.map(member => (
