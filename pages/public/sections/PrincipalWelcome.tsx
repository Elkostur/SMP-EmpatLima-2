  ...
  return (
    ...
    >
      <div className="container mx-auto px-6">
        <div 
          ref={sectionRef}
          className={`bg-white dark:bg-gray-800 p-8 md:p-12 rounded-xl shadow-2xl transform transition-all duration-700 ease-out ${hasAnimated ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-[20px]'}`}
        >
