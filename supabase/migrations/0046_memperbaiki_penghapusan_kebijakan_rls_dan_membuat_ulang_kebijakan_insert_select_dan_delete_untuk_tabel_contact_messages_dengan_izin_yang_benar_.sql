...
-- 3. Hapus semua kebijakan RLS yang mungkin ada untuk tabel contact_messages, termasuk yang menyebabkan konflik
...
DROP POLICY IF EXISTS "Allow anon and authenticated to view contact messages" ON public.contact_messages; -- Ini yang saya lewatkan sebelumnya!
...
-- 6. Buat ulang kebijakan SELECT untuk pengguna anonim dan terautentikasi
CREATE POLICY "Allow anon and authenticated to view contact messages" ON public.contact_messages
